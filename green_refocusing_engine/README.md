...
## Full-dataset evaluation + final CSV
Run on the whole RGB folder and export one final CSV:
```bash
python run_pipeline.py \
  --rgb_dir "/Users/sarthakjain/Desktop/ML Projects/GreenComputing/nyu_data/rbg_images" \
  --output_root outputs \
...
Final CSV path:
- `outputs/metrics/final_dataset_results.csv`

CSV columns:
- `image`, `PSNR_vs_original`, `SSIM_vs_original`, `MSE_vs_original`, `runtime_s`, `status`
- Includes an `__AVERAGE__` summary row.

## Dataset-scale benchmark (Green vs Baseline)
```bash
python -m src.main --max_images 50 \
  --rgb_dir "/Users/sarthakjain/Desktop/ML Projects/GreenComputing/nyu_data/rbg_images" \
  --depth_dir "/Users/sarthakjain/Desktop/ML Projects/GreenComputing/nyu_data/depth_images"
```

Generated CSV reports:
- `outputs/metrics/green_results.csv`
- `outputs/metrics/baseline_results.csv`
- `outputs/metrics/final_comparison.csv`

Generated plots:
- `outputs/plots/runtime_comparison.png`
- `outputs/plots/energy_comparison.png`
- `outputs/plots/fps_comparison.png`
- `outputs/plots/psnr_comparison.png`
- `outputs/plots/ssim_comparison.png`
- `outputs/plots/quality_efficiency_tradeoff.png`
